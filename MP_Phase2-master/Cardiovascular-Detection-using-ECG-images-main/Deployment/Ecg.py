...
class ECG:
	...
	def ModelLoad_predict(self,final_df):
		...
		if result[0] == 1:
			return "ECG corresponds to Myocardial Infarction"
		elif result[0] == 0:
			return "ECG corresponds to Abnormal Heartbeat"
		elif result[0] == 2:
			return "ECG is Normal"
		else:
			return "ECG corresponds to History of Myocardial Infarction"
